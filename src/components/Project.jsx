...
const Project = () => {
    ...
    return (
        <div className="section_main_project" id="project">
            <div className="inner">
                <div className="swiper mySwiper swiper_01">
                    <div className="slide_area swiper-slide" >
                        <h3 className="section_title">{`첫번째, 인컴즈에서의 이야기`}</h3>
                ...
                <div className="swiper mySwiper swiper_02" >
                    <div className="swiper-wrapper">
                        <h3 className="section_title">{`두번째, 교보문고에서의 이야기`}</h3>
                        <div className="section_text">
                            <p>IT기업의 체계적인 프로세스를 배웠습니다.</p>
                            <p>기본이 탄탄한 퍼블리셔로 성장했습니다.</p>
                        </div>
