    ...
    <div className="section_main_project" id="project">
      <div className="inner">
        ...
        <p className="des_text">
          더 나은 코드에 대한 고민을 바탕으로 진행한 작업들과, 예상치 못한
          상황에서 대응해 본 경험들은 <br />
          기술적 성장을 넘어 서비스를 바라보고, 사용자 편의를 생각할 줄 아는
          개발자로 성장하는 계기들이 되었습니다.
        </p>
        <div className="carrer_box">
                      ...
                      <dd className="info_des">
                        {project.tag.map((tag, index) => (
                          <span key={index} className="text_area">
                            <span
                              className={`label label_${getLabelClass(tag)}`}
                            >
                              {tag}
                            </span>
                          </span>
          ...
          <div className="carrer_02">
            ...
            <div className="section_text">
              <p>
                많은 협의체들과 함께 의사결정하는 과정을 통해 네트워킹에 대해
                배웠습니다.
              </p>
              <p>
                새로운 팀과 새로운 과제들을 바탕으로 새로운 것에 도전할 줄 아는
                웹 개발자로 성장할 발판을 마련했습니다.
              </p>
            </div>
            <ul className="carrer_list">
